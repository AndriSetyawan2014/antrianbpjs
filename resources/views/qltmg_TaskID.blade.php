...
<body>
    ...
    <script>
        ...
        document.getElementById('reset').addEventListener('click', function () {
            ...
            $('#qltmg_table').DataTable().search('').draw();
        });
    ...
    <div class="mb-3">
        <a href="{{ route('export_qltmg_taskid') }}" class="btn btn-success">Download Excel</a>
    </div>

    <!-- Tabel -->
    <div class="table-responsive mt-4" style="max-height: 490px; overflow-y: auto;">
        <table id="qltmg_table" class="table table-hover table-striped table-bordered" style="text-align: center;">
