...
<body>
    ...
    <!-- Filter by Date Form -->
    <form method="GET" action="{{ route('qltmg_rekap_taskid') }}">
        ...
        <a href="{{ route('qltmg_rekap_taskid') }}" class="btn btn-secondary">Reset</a>
    </form>
    ...
    <div class="table-responsive mt-4" style="max-height: 560px; overflow-y: auto;">
        <table id="qltmg_data_taskids" class="table table-hover table-striped table-bordered">
                ...
                @foreach($qltmg_TaskID as $row)
                    <tr>
                        ...
                        <td style="font-family: 'Poppins', sans-serif; font-size: 14px; text-align: left;">
                            <a href="{{ route('qltmg_TaskID', ['message' => $row->message, 'start_date' => $startDate, 'end_date' => $endDate]) }}" class="text-primary">
                                {{ $row->message }}
                            </a>
                        </td>
                        <td style="font-family: 'Poppins', sans-serif; font-size: 14px; text-align: center;">
