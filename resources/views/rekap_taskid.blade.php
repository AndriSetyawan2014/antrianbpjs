...
<body>
    ...
    <!-- Filter by Date Form -->
    <form method="GET" action="{{ route('rekap_taskid') }}">
        ...
        <a href="{{ route('rekap_taskid') }}" class="btn btn-secondary">Reset</a>
    </form>
        ...
        <table id="data_kodebooking" class="table table-hover table-striped table-bordered" style="text-align: center;">
            ...
            <tbody>
                ...
                @foreach($TaskID as $row)
                    <tr>
                        <td style="font-family: 'Poppins', sans-serif; font-size: 14px; text-align: center;">{{ $counter++ }}</td>
                        ...
                        <td style="font-family: 'Poppins', sans-serif; font-size: 14px; text-align: center;">{{ $row->total }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
